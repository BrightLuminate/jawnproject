            ...
            <div className="content-wrapper">
                <main className="program-content">
                    ...
                    <nav className="navbars">
                        <ul>
                            <li><Link to="/group-inquiry">모집요강</Link></li>
                            <li><Link to="/Curriculums">교육과정</Link></li>
                            <li><Link to="/Pricings">수강료안내</Link></li>
                            <li><Link to="/Onlines">온라인접수</Link></li>
                        </ul>
                    </nav>
                    ...
                    <section className="action-buttons">
                        <button onClick={() => handleButtonClick("/Curriculums")}>교육과정 상세보기</button>
                        <button onClick={() => handleButtonClick("/Onlines")}>온라인 접수하기</button>
                    </section>
                </main>
            </div>
