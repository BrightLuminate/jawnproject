      ...
      <div className="gugak-choir-intro">
        ...
        <div className="content">
          ...
          <section  className="description">
            ...
            <p>
              김영제류 해금산조보존회는 해금 명인 지영희 선생님으로부터 김영제 선생님에게 전수된 민속악의 정수를 보존하고 계승·발전시키기 위해 설립된 단체입니다.
              김영제류 해금산조는 김영제 선생님이 연주 생활을 통해 학습한 가락을 해금에 얹어 구성한 산조로, 1980년대부터 해금 전공 학생들에게 전수되기 시작했습니다.
              보존회의 주요 연주자인 류재원 선생님은 2021년 9월 28일 국가무형문화재 전수교육관 민속극장 풍류에서 '제16회 무사 류재원 해금 독주회: 현대에서 전통의 길을 걷다'를 개최하여 김영제류 해금산조의 현대적 해석을 선보였습니다
              이처럼 김영제류 해금산조 보존회는 전통 해금산조의 보존과 현대적 계승을 위해 지속적으로 노력하고 있습니다.
            </p>

            <h2>공연실적</h2>
            <ul>
              <li>김영제류 해금산조 연구 및 정기 연습 (2024년 6월, 12월)</li>
              <li>김영제 명인 전승 음악회</li>
              <li>2024년 국가무형 유산 거문고산조 김영제 보유자 공개 행사</li>
              <li>제 16회 류재원 해금 독주회 현대에서 전통의 길을 걷다</li>
              <li>술이부작 거문고 창작의 세계</li>
              <li>국립국악원 연주 참여</li>
              <li>전통예술 계승을 위한 학술 및 공연 행사</li>
              <li>유튜브 공연 영상 공개 (김영제류 해금 산조 연주) 
...
export default KimYoungJaeIntroduction;
